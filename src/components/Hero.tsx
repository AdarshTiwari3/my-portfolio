...
export function Hero() {
  const hero: HeroContent = {
    ...
    summary:
      "Building scalable, production-grade systems at Genpact. Focused on high-impact solutions for enterprise clients using modern web technologies and system design principles.",
    resumeDriveLink:
      "https://drive.google.com/file/d/1XNldMThpYPA5dhoxHj5Zx8Xl5jTkta-C/view?usp=sharing",
    githubLink: "https://github.com/AdarshTiwari3",
  };
